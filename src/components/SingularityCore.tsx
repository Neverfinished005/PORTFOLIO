...
export default function SingularityCore({ onEscape }: SingularityCoreProps) {
  ...
  return (
    ...
    >
      ...
      {/* Top Header */}
      <header className="sticky top-0 z-50 border-b border-white/[0.08] bg-[#09090b]/90 backdrop-blur-xl px-4 sm:px-8 py-3.5">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="hidden sm:inline-block w-px h-3 bg-zinc-800" />
          ...
          {/* Navigation Tabs */}
          <div className="flex items-center gap-1 bg-zinc-900/80 p-1 border border-white/[0.06] rounded-lg">
          ...
          <button
            ...
            onMouseEnter={() => soundEngine.playHoverSound()}
            className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-mono text-zinc-400 hover:text-white border border-white/[0.08] hover:border-white/[0.2] bg-zinc-900/60 hover:bg-zinc-800 rounded-lg transition-colors cursor-pointer"
          >
            <span>Close</span>
      ...
      {/* Main Container */}
      <main className="max-w-6xl mx-auto px-4 sm:px-8 py-8 sm:py-12 space-y-8 relative z-10">

        {/* ── PROFILE & HERO SECTION (Always visible or in Overview) ── */}
        {(activeTab === 'overview' || activeTab === 'stack' || activeTab === 'projects' || activeTab === 'contact') && (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
            
            {/* Left Card: Profile Dossier (4 cols) */}
            <div className="lg:col-span-4 border border-white/[0.08] bg-zinc-900/40 backdrop-blur-xl p-6 rounded-xl space-y-6">
              <div className="flex items-center gap-4">
                <div className="w-16 h-16 rounded-xl overflow-hidden border border-white/[0.1] bg-zinc-800 flex-shrink-0">
                  <img 
                    ...
                    onError={(e) => {
                      // Fallback monogram if image not present
              ...
              <div className="space-y-3 pt-4 border-t border-white/[0.06] text-xs leading-relaxed text-zinc-300">
                <p>
                  Full-stack developer and machine learning builder based in Pune, India.
                </p>
              ...
              <div className="pt-4 border-t border-white/[0.06] space-y-2">
                ...
                <div className="flex items-center justify-between text-xs text-zinc-400 font-mono">
                  ...
                  <span className="text-zinc-200">30+ Repositories</span>
                </div>
                <div className="flex items-center justify-between text-xs text-zinc-400 font-mono">
              ...
              <div className="pt-4 border-t border-white/[0.06] grid grid-cols-3 gap-2">
                <a
                  ...
                  rel="noreferrer"
                  onMouseEnter={() => soundEngine.playHoverSound()}
                  className="flex flex-col items-center justify-center py-2 px-2 border border-white/[0.08] hover:border-white/[0.2] bg-zinc-900/60 hover:bg-zinc-800 rounded-lg text-zinc-300 hover:text-white transition-colors"
                >
                ...
                <a
                  ...
                  rel="noreferrer"
                  onMouseEnter={() => soundEngine.playHoverSound()}
                  className="flex flex-col items-center justify-center py-2 px-2 border border-white/[0.08] hover:border-white/[0.2] bg-zinc-900/60 hover:bg-zinc-800 rounded-lg text-zinc-300 hover:text-blue-400 transition-colors"
                >
                ...
                <a
                  ...
                  rel="noreferrer"
                  onMouseEnter={() => soundEngine.playHoverSound()}
                  className="flex flex-col items-center justify-center py-2 px-2 border border-white/[0.08] hover:border-white/[0.2] bg-zinc-900/60 hover:bg-zinc-800 rounded-lg text-zinc-300 hover:text-pink-400 transition-colors"
                >
            ...
            {/* Right Area: Dynamic content depending on activeTab (8 cols) */}
            <div className="lg:col-span-8 space-y-6">

              {/* ── OVERVIEW / TECHNICAL STACK ── */}
              {(activeTab === 'overview' || activeTab === 'stack') && (
                <div className="border border-white/[0.08] bg-zinc-900/40 backdrop-blur-xl p-6 rounded-xl space-y-5">
              ...
              {(activeTab === 'overview' || activeTab === 'projects') && (
                <div className="border border-white/[0.08] bg-zinc-900/40 backdrop-blur-xl p-6 rounded-xl space-y-4">
                  <div className="flex items-center justify-between pb-3 border-b border-white/[0.06]">
                    <h2 className="text-sm font-semibold text-white tracking-wide">
                  ...
                  <div className="space-y-3">
                    {FEATURED_PROJECTS.map((project) => (
                      <a
                        ...
                        rel="noreferrer"
                        onMouseEnter={() => soundEngine.playHoverSound()}
                        className="block p-4 rounded-lg border border-white/[0.06] hover:border-white/[0.18] bg-zinc-950/40 hover:bg-zinc-900/60 transition-all group"
                      >
                        <div className="flex items-start justify-between gap-2 mb-1.5">
                          ...
                          <span className="text-[10px] font-mono text-zinc-400 px-2 py-0.5 rounded border border-white/[0.08]">
                            {project.role}
                          </span>
                        </div>
                ...
                <div className="border border-white/[0.08] bg-zinc-900/40 backdrop-blur-xl p-6 rounded-xl space-y-4">
                  <div className="flex items-center justify-between pb-3 border-b border-white/[0.06]">
                    <div>
                      ...
                      <p className="text-xs text-zinc-400 mt-0.5">
                        Send a message directly to rudra.vable@gmail.com
                      </p>
                    </div>
                    <button
                      type="button"
                  ...
                  <form onSubmit={handleSendMessage} className="space-y-3.5 text-xs">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      <div>
                        <label className="block font-mono text-zinc-400 mb-1.5">
                          Your Name / Team
                        </label>
                        <input
                          type="text"
                          ...
                          className="w-full px-3 py-2 bg-zinc-950 border border-white/[0.08] focus:border-white/[0.3] rounded-lg text-white placeholder-zinc-600 focus:outline-none transition-colors"
                        />
                      </div>
                      <div>
                        <label className="block font-mono text-zinc-400 mb-1.5">
                        ...
                        <select
                          ...
                          className="w-full px-3 py-2 bg-zinc-950 border border-white/[0.08] focus:border-white/[0.3] rounded-lg text-white focus:outline-none transition-colors"
                        >
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full px-3 py-2 bg-zinc-950 border border-white/[0.08] focus:border-white/[0.3] rounded-lg text-white placeholder-zinc-600 focus:outline-none transition-colors resize-none"
                      />
                    </div>
                    ...
                    <div className="flex items-center justify-end pt-1">
                      <button
                        type="submit"
                        onMouseEnter={() => soundEngine.playHoverSound()}
                        className="flex items-center gap-2 px-5 py-2.5 bg-white text-zinc-950 font-medium text-xs rounded-lg hover:bg-zinc-200 transition-colors cursor-pointer shadow-sm"
                      >
